// Shared VR application logic for interactive hand cubes with trigger input
    ...
    pub fn render(self: *VRApp) void {
        ...
        if (rendering_vr) {
            ...
            if (self.left_hand.valid) {
                ...
                c.DrawModelEx(self.hand_model, self.left_hand.position, axis, angle * c.RAD2DEG, c.Vector3One(), left_color);
            }
            ...
            if (self.right_hand.valid) {
                ...
                c.DrawModelEx(self.hand_model, self.right_hand.position, axis, angle * c.RAD2DEG, c.Vector3One(), right_color);
            }
